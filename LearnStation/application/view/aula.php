	...
	<section>
		<div class="curso">
			...
			<div class="descricao">
				...
				<p>Suspendisse id metus condimentum, rhoncus nibh quis, semper turpis. Donec id nunc ultricies, convallis est sit amet, dictum dui. Vivamus eu massa commodo, fermentum ex eu, imperdiet lacus. Vestibulum auctor velit quis sapien ornare, et ullamcorper ante vestibulum. Sed pharetra neque ex, vitae volutpat risus sollicitudin vel. Fusce ultricies in lorem porttitor aliquam. Maecenas posuere scelerisque ipsum, ut vulputate purus suscipit ac. Nam venenatis mi est, eu finibus mi scelerisque sed. Praesent ut lorem sapien. Ut vitae felis eros. Sed mattis congue odio, ac venenatis nisl aliquet sed. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam viverra vestibulum massa, eget pharetra felis facilisis et. Vivamus eget imperdiet urna, at euismod mauris.</p>
			</div>
			<div class="media">
			<br><br>
				<header>Vídeo</header>
