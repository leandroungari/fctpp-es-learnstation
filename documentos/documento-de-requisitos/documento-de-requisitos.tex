...
\item RF. 1.10: Avaliar qualidade de cursos.
...
\item RF. 1.11: Prover maior segurança das informações dos usuários.
\item \qquad Será realiza a criptografia da senha dos usuários.

\item RF. 1.12: Enviar e receber mensagens para um amigo.
...
\item RF. 1.13: Notificações recebidas.
...
\item RF. 1.14: Encerramento de conta de usuário.
\item \qquad O usuário pode encerrar sua conta na rede social.

%RF. 2: Curso.
\item RF. 2.1: Adicionar uma aula a um determinado curso.
...
\item RF. 2.2: Exibir descrição do curso.
...
\item RF. 3.1: Acesso a listagem de todos os conteúdos.
...
\item RF. 3.2: Remoção de conteúdos classificados inadequados
...
\item RF. 3.3: Envio de notificação de advertência ao usuário.
